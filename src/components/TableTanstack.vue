    ...
    <div class="mt-1 flow-root">
            ...
            <thead>
              ...
              >
                <th
                  ...
                  :key="header.id"
                  scope="col"
                  class="border border-solid px-3 py-3.5 text-left text-lg font-semibold text-gray-900"
                  :class="{
            ...
            <tbody class="divide-y divide-gray-200">
              <tr class="border border-solid" v-for="row in table.getRowModel().rows" :key="row.id">
                <td
                  ...
                  :key="cell.id"
                  class="border border-solid whitespace-nowrap px-3 py-4 text-lg text-gray-500"
                >
                  <FlexRender
      ...
      <div class="mt-8 space-x-4">
        <button
          ...
          @click="table.setPageSize(15)"
        >
          Page Size 15
        </button>
        <button
          class="border border-gray-300 rounded px-2 py-2 disabled:opacity-50 disabled:cursor-not-allowed"
          @click="table.setPageSize(30)"
        >
          Page Size 30
        </button>
        <button
          class="border border-gray-300 rounded px-2 py-2 disabled:opacity-50 disabled:cursor-not-allowed"
          @click="table.setPageSize(60)"
        >
          Page Size 60
        </button>
      </div>
